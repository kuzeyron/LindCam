...
requirements = python3,kivy,trio==0.23.2,androidstorage4kivy,attrs,sniffio,outcome,sortedcontainers
...
icon.filename = %(source.dir)s/icons/snap.png
...
presplash.filename = %(source.dir)s/icons/background.png
